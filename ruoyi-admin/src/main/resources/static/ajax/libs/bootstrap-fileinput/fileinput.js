...
//                  'data': zoom && vZoomData ? self.zoomPlaceholder + '{zoomData}' : vData,
    ...
    $.fn.fileinputLocales.zh = {
            ...
            msgSizeTooSmall: '文件 "{name}" (<b>{size}</b>) 必須大於限定大小 <b>{minSize}</b>.',
            msgSizeTooLarge: '文件 "{name}" (<b>{size}</b>) 超過了允許大小 <b>{maxSize}</b>.',
            msgFilesTooLess: '你必須選擇最少 <b>{n}</b> {files} 來上傳. ',
            msgFilesTooMany: '選擇的上傳文件個數 <b>({n})</b> 超出最大文件的限制個數 <b>{m}</b>.',
            msgTotalFilesTooMany: '你最多可以上傳 <b>{m}</b> 個文件 (當前有<b>{n}</b> 個文件).',
            ...
            msgInvalidFileName: '檔案名 "{name}" 包含非法字元.',
            msgInvalidFileType: '不正確的類型 "{name}". 只支持 "{types}" 類型的文件.',
            msgInvalidFileExtension: '不正確的文件副檔名 "{name}". 只支持 "{extensions}" 的文件副檔名.',
            msgFileTypes: {
                'image': 'image',
                'html': 'HTML',
                'text': 'text',
            ...
            msgUploadEnd: '完成',
            msgUploadResume: '繼續上傳 &hellip;',
            msgUploadEmpty: '無效的文件上傳.',
            msgUploadError: '上傳出錯',
            msgDeleteError: '刪除出錯',
            msgProgressError: '上傳出錯',
            msgValidationError: '驗證錯誤',
            msgLoading: '載入第 {index} 文件 共 {files} &hellip;',
            ...
            msgImageResizeException: '調整圖像大小時發生錯誤。<pre>{errors}</pre>',
            msgAjaxError: '{operation} 發生錯誤. 請重試!',
            msgAjaxProgressError: '{operation} 失敗',
            msgDuplicateFile: '文件 "{name}",大小 "{size}" 已經被選中.忽略相同的文件.',
            msgResumableUploadRetriesExceeded:  '文件 <b>{file}</b> 上傳失敗超過 <b>{max}</b> 次重試 ! 錯誤詳情: <pre>{error}</pre>',
            msgPendingTime: '{time} 剩餘',
            msgCalculatingTime: '計算剩餘時間',
            ajaxOperations: {
                deleteThumb: '刪除文件',
                uploadThumb: '上傳文件',
                uploadBatch: '批次上傳',
            ...
            dropZoneTitle: '拖拽文件到這裡 &hellip;<br>支持多文件同時上傳',
            ...
            fileActionSettings: {
                ...
                downloadTitle: '下載文件',
                uploadRetryTitle: '重試',
                rotateTitle: '順時針旋轉90度',
                zoomTitle: '查看詳情',
                dragTitle: '移動 / 重設',
                indicatorNewTitle: '沒有上傳',
                indicatorSuccessTitle: '上傳',
                indicatorErrorTitle: '上傳錯誤',
                indicatorPausedTitle: '上傳已暫停',
                indicatorLoadingTitle:  '上傳 &hellip;'
            },
            previewZoomButtonTitles: {
                prev: '預覽上一個文件',
                next: '預覽下一個文件',
